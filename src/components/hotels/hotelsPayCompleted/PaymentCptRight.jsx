...
const PaymentCptRight = () => {
    return (
            <div className="pay payment-right">
                <div className="res-title">
                    <div className="ht-img">{/*props 호텔 썸네일*/}
                        <img src="" alt="" />
                    </div>
                    <div className="text">
                        <span>{/*props*/}호텔 3성급</span>
                        <span>{/*props*/}그랜드 하얏트 제주</span>
                        <span>{/*props*/}슈페리어 트윈 SPT</span>
                    </div>
                </div>
                ...
                <button>
                    450,760{/*props*/}원 결제하기
                </button>
            </div>
    );
};

export default PaymentCptRight;