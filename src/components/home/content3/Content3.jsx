...
import "./style.scss"; // 이 줄의 주석을 제거하고 실제 프로젝트에서 사용하세요
  ...
  useEffect(() => {
    ...
    const updateCarousel = () => {
      items.forEach((item, index) => {
        ...
        const zIndex = totalItems - Math.min(offset, totalItems - offset);
        const opacity = Math.max(0, Math.min(1, (zIndex / totalItems) * 3 - 2));

        item.style.setProperty("--active", isActive);
        ...
        const x = isActive * 800;
        const y = isActive * 200;
        const rot = isActive * 120;
  ...
  const items = [
    {
      title: "Paris",
      num: "01",
      src: "./images/main/stay1.png",
    },
    {
      title: "Warsaw",
      num: "02",
      src: "./images/main/stay2.png",
    },
    {
      title: "Madrid",
      num: "03",
      src: "./images/main/stay3.png",
    },
    {
      title: "Sydney",
      num: "04",
      src: "./images/main/stay4.png",
    },
    {
      title: "Istanbul",
      num: "05",
      src: "./images/main/stay5.png",
    },
    {
      title: "Prague",
      num: "06",
