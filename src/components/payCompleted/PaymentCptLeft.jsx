...
const PaymentCptLeft = ({ hotel, selectedRoom }) => {
    return (
        <div className="pay payment-left">
            <div className="pay-detail">
                ...
                <div className="cpt-message">
                    <img src="/images/icon/completed.svg" alt="예약 완료" />
                    <strong>숙소 예약이 완료되었습니다.</strong>
                    <p>예약번호: STAY2024-KR789{/*props*/}</p>
                </div>
                <div className="reserve-info"></div>
